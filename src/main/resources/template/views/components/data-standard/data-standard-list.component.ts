...
import { DataStandardService } from '../../services/index';
import { PubSubService , DictCacheService } from '../../../../common/src/services/index';

@Component({
    selector: 'app-data-standard-list',
    templateUrl: './data-standard-list.component.html',
    styles: [ `
...
export class DataStandardListComponent implements OnInit {
    ...
    */
    ...
    ngOnInit() {
        this.category['code'] = 'DATA_STANDARD';
        this.load();
    }
    ...
    load() {
        this.loading = true;
        this.dataStandardService.findPage(
     ...
     */
    delete(item) {
        this.dataStandardService.logicDeleteById(item.id).subscribe(data => {
